...
![Build Status](https://github.com/shp2015/devops-capstone-project/actions/workflows/ci-build.yaml/badge.svg)

This repository is created during "DevOps Capstone Project" course's Module 1's lab "Hands-on Lab: Agile Planning using Github" which is part of the [**IBM DevOps and Software Engineering Professional Certificate**](https://www.coursera.org/professional-certificates/devops-and-software-engineering)
